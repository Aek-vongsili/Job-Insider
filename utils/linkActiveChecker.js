...
export const isActiveLink2 = (menuPath, routePath) => {
    if (menuPath && routePath) {
        // Check if the routePath starts with the menuPath or if the menuPath is empty
        return routePath.startsWith(menuPath) || menuPath === '';
    }
    return false;
};
